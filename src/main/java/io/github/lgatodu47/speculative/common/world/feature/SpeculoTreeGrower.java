...
public class SpeculoTreeGrower extends AbstractTreeGrower {
    public static final TreeConfiguration SPECULO_TREE_CONFIG = new TreeConfiguration.TreeConfigurationBuilder(
    ...
    public static final TreeConfiguration FANCY_SPECULO_TREE_CONFIG = new TreeConfiguration.TreeConfigurationBuilder(
            BlockStateProvider.simple(SpeculativeBlocks.SPECULO_LOG.get()),
