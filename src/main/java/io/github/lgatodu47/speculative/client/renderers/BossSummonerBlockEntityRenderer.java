...
public class BossSummonerBlockEntityRenderer implements BlockEntityRenderer<BossSummonerBlockEntity> {
    public BossSummonerBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
    }
